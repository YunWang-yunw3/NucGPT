...
# model = RWKV(model='/Users/philipm614/Desktop/Model Weights/Subweights/RWKV-4b-Pile-436M-20230211-8012.pth', strategy='cpu bf16')
model = RWKV(model='models/RWKV-4b-Pile-171M-20230202-7922.pth', strategy='cpu bf16')
